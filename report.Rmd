...
Note: the token for Facebook API is temporary, so we wrote the data on an attached file, called sources/fb_network.csv, and saved the results.
...
```{r}
plot(fb_graph, vertex.color=fb_edge_betweenness_com$membership, edge.arrow.size=0)
```
